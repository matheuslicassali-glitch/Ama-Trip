...
import { Camera, MapPin, Navigation, CheckCircle2, Image as ImageIcon, Trash2 } from 'lucide-react';
                    ...
                    <div className="space-y-2">
                        ...
                        {startPreview ? (
                            <div className="relative rounded-xl overflow-hidden border-2 border-primary/50 group">
                                <img src={startPreview} alt="Preview" className="w-full h-64 object-cover" />
                                <div className="absolute inset-0 bg-black/60 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                                    <button
                                        type="button"
                                        onClick={() => { setStartFile(null); setStartPreview(null); }}
        ...
        <div className="max-w-2xl mx-auto space-y-6 animate-in zoom-in-95 duration-500">
            ...
            <form onSubmit={handleEnd} className="glass-morphism p-8 rounded-2xl space-y-6">
                ...
                <div className="space-y-2">
                    ...
                    {endPreview ? (
                        <div className="relative rounded-xl overflow-hidden border-2 border-primary/50 group">
                            <img src={endPreview} alt="Preview" className="w-full h-64 object-cover" />
                            <div className="absolute inset-0 bg-black/60 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                                <button
                                    type="button"
